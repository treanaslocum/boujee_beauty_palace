  ...
  <div>
    ...
    <section class="flex sm:flex-row flex-col mt-24 m-16">
      <div class="flex justify-center  mb-10 sm:w-2/4 w-full">
        <img class="h-3/4 w-2/3" src="~/assets/images/hourglass.png" alt="">
      </div>
      <div class="mt-24 sm:w-2/4 w-full">
        <h2 class="mb-8 text-4xl font-semibold">Hourglass</h2>
        <p class="mb-12">Abdomen & Booty Contouring</p>
        <h3 class="mb-8 text-xl font-medium">Service Description</h3>
        <p class="mb-6 w-2/4">Ultrasonic Cavitation, Columbian wood tool therapy, RF therapy, Vacuum therapy, use of fat burning, skin tightening, and booty plumping oils</p>
     
        <div class="mb-6 flex items-center">
          <img class="w-6 mr-4" src="~assets/icons/clock-black.svg" alt="">
          <p class="mr-20">45 min</p>
          <p class="-ml-2 text-2xl font-medium">$125</p>
        </div>
