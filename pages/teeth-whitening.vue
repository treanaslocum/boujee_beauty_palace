  ...
  <div>
    ...
    <section class="flex sm:flex-row flex-col sm:mt-24 mt-0 m-16">
      <div class="flex justify-center  mb-10 sm:w-2/4 w-full">
        <img class="sm:visible invisible h-3/4 w-2/3" src="~/assets/images/teeth.png" alt="">
      </div>
      <div class="sm:mt-24 mt-0 sm:w-2/4 w-full">
        <h2 class="mb-8 text-4xl font-semibold">Teeth Whitening</h2>
        <p class="mb-12">Teeth Whitening 30 minutes</p>
        <h3 class="mb-8 text-xl font-medium">Service Description</h3>
        <p class="mb-6 w-2/4">30 minutes of Whitening (up to 5 shades) Dental Grade</p>
