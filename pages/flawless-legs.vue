  ...
  <div>
    ...
    <section class="flex sm:flex-row flex-col sm:mt-24 mt-0 m-16">
      <div class="flex justify-center  mb-10 sm:w-2/4 w-full">
        <img class="sm:visible invisible h-3/4 w-2/3" src="~/assets/images/legs.png" alt="">
      </div>
      <div class="sm:mt-24 mt-0 sm:w-2/4 w-full">
        <h2 class="mb-8 text-4xl font-semibold">Flawless Legs</h2>
        <p class="mb-12">Legs only</p>
        <h3 class="mb-8 text-xl font-medium">Service Description</h3>
        <p class="mb-6 w-2/4">RF therapy, Columbian wood tool therapy, Ultrasonic Cavitation, cellulite, fat burning and skin tightening oils</p>
