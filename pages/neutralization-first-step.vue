  ...
  <div>
    ...
    <section class="flex sm:flex-row flex-col sm:mt-24 mt-0 m-16">
      <div class="flex justify-center  mb-10 sm:w-2/4 w-full">
        <img class="sm:visible invisible h-3/4 w-2/3" src="~/assets/images/lip-neutralization.png" alt="">
      </div>
      <div class="sm:mt-24 mt-0 sm:w-2/4 w-full">
        <h2 class="mb-8 text-4xl font-semibold">Neutralization (1st step)</h2>
        <!-- <p class="mb-12">Booty only</p> -->
        <h3 class="mb-8 text-xl font-medium">Service Description</h3>
        <!-- <p class="mb-6 w-2/4">xxx</p> -->
     
        <div class="mb-6 flex items-center">
          <img class="w-6 mr-4" src="~assets/icons/clock-black.svg" alt="">
          <p class="mr-20">3 hrs</p>
          <p class="-ml-2 text-2xl font-medium">$500</p>
        </div>
